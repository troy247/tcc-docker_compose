...
$query = mysqli_query($con, "UPDATE kendaraan SET jenis='$jenis_kendaraan', merk='$merk_kendaraan', warna='$warna_kendaraan', tahun='$tahun', bbm='$bahan_bakar', nopol='$nomor_polisi', norangka='$nomor_rangka', nomesin='$nomor_mesin', pemilik='$pemilik', alamat='$alamat_pemilik' WHERE id='$id'") or die(mysqli_error($con));
if($query) {
